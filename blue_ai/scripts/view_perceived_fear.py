...
env = Image2VecWrapper(TransientGoals(img_filename='env1.png', n_transient_goals=0, transient_obstacles=[(4, 5)], agent_start_pos=(3, 5), agent_start_dir=1, render_mode='rgb_array'))
state, _ = env.reset()
...
for trial in range(1):
    ...
    agent_healthy.policy_net.eval()
    agent_dep.policy_net.eval()
