...
ax = plt.gca()
x = data['step'].unique()
ax.fill_between(x, -1000, 100000, where=x < 20000, color='skyblue', alpha=0.25)
ax.fill_between(x, -1000, 100000, where=(x >= 20000) & (x <= 40000), color='salmon', alpha=0.25)
ax.fill_between(x, -1000, 100000, where=x > 40000, color='skyblue', alpha=0.25)
