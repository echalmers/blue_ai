...
#vizualise the average reward of the trials generated by rehabilitate.py
...
def main():
    ...
    #plot a shaded linegraph of the rewards
    ...
    plt.suptitle(f"Average reward per timestep. Trial-ID: {id}")
