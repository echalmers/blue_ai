...
plt.sca(axes['d'])
sns.lineplot(results[results['stress_length'] == 10], x='episode', y='expected_shortterm')
sns.lineplot(results[results['stress_length'] == 10], x='episode', y='expected_longterm')
axes['d'].axvspan(500, 510, color='red', alpha=0.5)
...
axes['e'].axvspan(500, 550, color='red', alpha=0.5)
