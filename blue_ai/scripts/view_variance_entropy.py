...
#calculate and visualize the variance entropy of the files generated by rehabilitate.py
...
#discretize distances for plotting
...
def main():
    ...
    #calculates the entropy for each stage in each rep
    ...
    data = f'9_treated_0_activations.parquet'
