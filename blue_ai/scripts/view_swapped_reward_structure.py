...
sns.barplot(data=high_terminal_goals, x='dropout', y='count', hue='event', n_boot=n_boot, palette=['tab:green', 'tab:blue'])
...
sns.barplot(data=high_transient_goals, x='dropout', y='count', hue='event', n_boot=n_boot, palette=['tab:green', 'tab:blue'])
...
transient_count_1 = high_terminal_goals[high_terminal_goals['event'] == 'optional goal found'][['dropout', 'count']].set_index('dropout')
transient_count_2 = high_transient_goals[high_transient_goals['event'] == 'optional goal found'][['dropout', 'count']].set_index('dropout')
